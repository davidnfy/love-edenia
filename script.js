...
let particleSizeFactor = Math.floor((canvasWidth * canvasHeight) / 29000);
...
function render() {
    ...
    particles.forEach(particle => {
        ...
        if (isInHeart) {
            ...
            ctx.fillStyle = `rgba(255, 20, 147, ${particle.opacity})`;  // changed pink to deep pink (FF1493)
        } else {
...
function resizeCanvas() {
    ...
    particleSizeFactor = Math.floor((canvasWidth * canvasHeight) / 29000);
